...
//        context = getInstance("classpath*:/com-mq-test-context.xml");
        ...
        properties.setProperty("bootstrap.servers", "192.168.0.103:9092");
...
//        context = getInstance("classpath*:/com-mq-test-context.xml");
        ...
        consumerProperties.put("bootstrap.servers", "192.168.0.103:9092,127.0.0.1:9092");
//        consumerProperties.put("advertised.host.name","192.168.0.103");
//        consumerProperties.put("metadata.broker.list","192.168.0.103:9092,127.0.0.1:9092");
...
//        context = getInstance("classpath*:/com-mq-test-context.xml");
        ...
        Properties consumerProperties = new Properties();
        consumerProperties.put("bootstrap.servers", "192.168.0.103:9092");
